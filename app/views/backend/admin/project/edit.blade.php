...
{{ HTML::style('Backend/assets/css/dashboard/jqtransform.css') }}
...
{{ HTML::script('Backend/assets/js/dashboard/userlist.js') }}
{{ HTML::script('Backend/assets/js/simplelogin/parsley.js') }}
{{ HTML::script('Backend/assets/js/jquery/jquery.jqtransform.js') }}
